...
-- Rental Manager privileges (full CRUD for inventory/rental modules)
INSERT IGNORE INTO `privilage` (`priv_insert`, `priv_select`, `priv_update`, `priv_delete`, `module_id`, `role_id`, `addeddatetime`) VALUES
(1, 1, 1, 1, 19, 10, NOW()),
(1, 1, 1, 1, 20, 10, NOW()),
(1, 1, 1, 1, 22, 10, NOW()),
...
('rentalmanager1', '$2a$10$AMedQYu1NJBwf742yTgU9.9iuenryB6PT9sQXhcnb.oof52NkfQ2W', 1, 'Rental Manager', NOW(), 5);
...
('ITM10001', 'Classic White Wedding Gown', 'A-line silhouette with lace details', NOW(), 'WEDDING_DRESSES', 'AVAILABLE', 15000.00, 5000.00, 'M'),
('ITM10002', 'Vintage Lace Wedding Dress', 'Victorian-inspired with long sleeves', NOW(), 'WEDDING_DRESSES', 'AVAILABLE', 18000.00, 6000.00, 'S'),
...
('ITM10008', 'Embroidered Clutch Bag', 'Silk clutch with beadwork', NOW(), 'ACCESSORIES', 'UNDER_MAINTENANCE', 2500.00, 600.00, 'M');
...
INSERT IGNORE INTO `appointment` (`appointment_no`, `date`, `start_time`, `end_time`, `duration`, `price`, `note`, `addeddatetime`, `appointment_status`, `booking_method`, `employee_id`, `customer_id`) VALUES
('APT00001', '2025-06-15', '09:00:00', '10:30:00', 90.00, 2500.00, 'Regular haircut', '2025-06-14 10:00:00', 'COMPLETED', 'PHONE', 1, 1),
('APT00002', '2025-06-20', '10:00:00', '13:00:00', 180.00, 15000.00, 'Bridal trial session', '2025-06-18 14:00:00', 'COMPLETED', 'WALK_IN', 2, 3),
('APT00003', '2025-06-25', '14:00:00', '16:00:00', 120.00, 5000.00, 'Hair coloring appointment', '2025-06-23 09:00:00', 'COMPLETED', 'PHONE', 1, 2),
('APT00004', '2025-07-02', '11:00:00', '12:00:00', 60.00, 3500.00, 'Facial treatment', '2025-06-30 16:00:00', 'COMPLETED', 'ONLINE', 3, 5),
('APT00005', '2025-07-05', '09:00:00', '09:45:00', 45.00, 1500.00, 'Manicure session', '2025-07-03 11:00:00', 'CANCELLED', 'WALK_IN', 4, 4),
('APT00006', '2025-07-14', '10:00:00', '11:00:00', 60.00, 4500.00, 'Party makeup for event', '2025-07-10 08:00:00', 'CONFIRMED', 'PHONE', 2, 6),
('APT00007', '2025-07-15', '14:00:00', '15:30:00', 90.00, 4000.00, 'Hair spa treatment', '2025-07-11 15:00:00', 'CONFIRMED', 'ONLINE', 1, 7),
('APT00008', '2025-07-16', '09:00:00', '16:00:00', 480.00, 25000.00, 'Full bridal package', '2025-07-12 10:00:00', 'PENDING', 'WALK_IN', 2, 8),
('APT00009', '2025-07-18', '11:00:00', '12:00:00', 60.00, 3500.00, 'Facial treatment', '2025-07-14 09:00:00', 'PENDING', 'PHONE', 3, 1),
('APT00010', '2025-07-20', '15:00:00', '16:30:00', 90.00, 4000.00, 'Hair spa for wedding guest', '2025-07-15 12:00:00', 'CONFIRMED', 'ONLINE', 1, 3);
...
-- Appointment Has Service (sample data for individual services in appointments)
INSERT IGNORE INTO `appointment_has_service` (`appointment_id`, `service_id`, `service_price`) VALUES
(1, 1, 2500.00),
(2, 3, 15000.00),
(3, 2, 5000.00),
(4, 4, 3500.00),
...
INSERT IGNORE INTO `rental_has_item` (`rental_id`, `item_id`, `alteration_required`, `alteration_note`, `item_price`, `is_pickup`) VALUES
(1, 1, 0, NULL, 15000.00, 1),
(1, 3, 0, NULL, 5000.00, 1),
(2, 3, 0, NULL, 5000.00, 1),
(2, 4, 0, NULL, 7000.00, 1),
(3, 2, 1, 'Hem adjustment needed', 12000.00, 1),
(3, 6, 0, NULL, 2000.00, 1),
(4, 5, 0, NULL, 3000.00, 0),
(5, 4, 0, NULL, 7000.00, 0),
(6, 6, 0, NULL, 2000.00, 0),
(6, 7, 0, NULL, 3500.00, 0);

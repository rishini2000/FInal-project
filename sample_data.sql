...
INSERT IGNORE INTO `handover` (`id`, `actual_return_date`, `actual_return_time`, `return_person`, `damage_charge`, `cleaning_charge`, `late_return_fee`, `total_refund`, `damage_description`, `return_note`, `addeddatetime`, `handover_status_id`, `item_condition_id`, `rental_id`) VALUES
(1, '2025-06-21', '15:00:00', 'Kavindi Perera', 0.00, 500.00, 0.00, 44500.00, NULL, 'Returned in good condition', '2025-06-21 15:00:00', 1, 1, 1),
(2, '2025-06-29', '16:00:00', 'Hashini Fernando', 0.00, 0.00, 0.00, 15000.00, NULL, 'All items returned', '2025-06-29 16:00:00', 1, 1, 2),
